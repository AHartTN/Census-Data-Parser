namespace CensusDataParser.Generated.CensusDataParser.Generated.SummaryTwo
{
    ...
    [Table("SF2_Segment_01")]
    public partial class SF2_Segment_01 : BaseModel
    {
        #region Properties
        [MaxLength(255)]
        [ReadOnly(false)]
        ...
        #region Constructors
        public SF2_Segment_01(string csvLine) : base(csvLine) {}

        public SF2_Segment_01(string[] values) : base(values) {}

        public SF2_Segment_01(OleDbDataReader reader, CensusFileType fileType)
        {
