namespace CensusDataParser.Generated.CensusDataParser.Generated.SummaryTwo
{
    ...
    [Table("SF2_GeoHeader")]
    public partial class SF2_GeoHeader : BaseModel
    {
        #region Properties
        [MaxLength(6)]
        [ReadOnly(false)]
        ...
        public System.String AREALAND { get; set; }
        ...
        public System.String AREAWATR { get; set; }
        ...
        #region Constructors
        public SF2_GeoHeader(string csvLine) : base(csvLine) {}

        public SF2_GeoHeader(string[] values) : base(values) {}

        public SF2_GeoHeader(OleDbDataReader reader, CensusFileType fileType)
        {
            ...
            {
                AREALAND = (System.String)reader[63];
            }
            if(reader[64] != DBNull.Value)
            {
                AREAWATR = (System.String)reader[64];
            }
