namespace CensusDataParser.Generated.Binding
{
	...
	public class SummaryTwo_SF2_Segment_04 : BaseModel
	{
		...
		public decimal? PCT0070001 { get; set; }
		...
		public decimal? PCT0070002 { get; set; }
		...
		public decimal? PCT0070003 { get; set; }
		...
		public SummaryTwo_SF2_Segment_04(OleDbDataReader reader)
		{
			...
			{
				PCT0070001 = (decimal?)reader[57];
			}
			if(reader[58] != DBNull.Value)
			{
				PCT0070002 = (decimal?)reader[58];
			}
			if(reader[59] != DBNull.Value)
			{
				PCT0070003 = (decimal?)reader[59];
			}
