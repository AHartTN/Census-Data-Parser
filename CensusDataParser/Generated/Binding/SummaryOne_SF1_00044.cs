...
// Authored: 01/02/2016 11:49 AM
// 
// Solution: CensusDataParser
// Project: CensusDataParser
// File: SummaryOne_SF1_00044.cs
// 
...
namespace CensusDataParser.Generated.Binding
{
    ...
    public class SummaryOne_SF1_00044 : BaseModel
    {
        #region Properties
        [MaxLength(255)]
        [ReadOnly(false)]
        ...
        #region Constructors
        public SummaryOne_SF1_00044(string csvLine) : base(csvLine) { }

        public SummaryOne_SF1_00044(string[] values) : base(values) { }

        public SummaryOne_SF1_00044(OleDbDataReader reader, CensusFileType fileType)
        {
            ...
            {
                H0120001 = (double?)reader[72];
            }
            if (reader[73] != DBNull.Value)
            {
                H0120002 = (double?)reader[73];
            }
            if (reader[74] != DBNull.Value)
            {
                H0120003 = (double?)reader[74];
            }
