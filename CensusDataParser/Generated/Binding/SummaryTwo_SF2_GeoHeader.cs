...
// File: SummaryTwo_SF2_GeoHeader.cs
// 
...
namespace CensusDataParser.Generated.Binding
{
    ...
    public class SummaryTwo_SF2_GeoHeader : BaseModel
    {
        #region Properties
        ...
        #region Constructors
        public SummaryTwo_SF2_GeoHeader() { }

        public SummaryTwo_SF2_GeoHeader(string csvLine) : base(csvLine) { }

        public SummaryTwo_SF2_GeoHeader(string[] values) : base(values) { }

        public SummaryTwo_SF2_GeoHeader(OleDbDataReader reader)
        {
