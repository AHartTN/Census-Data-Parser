...
// File: SummaryOne_DATA_FIELD_DESCRIPTORS.cs
// 
...
namespace CensusDataParser.Generated.Binding
{
    ...
    public class SummaryOne_DATA_FIELD_DESCRIPTORS : BaseModel
    {
        #region Properties
        ...
        #region Constructors
        public SummaryOne_DATA_FIELD_DESCRIPTORS() { }

        public SummaryOne_DATA_FIELD_DESCRIPTORS(string csvLine) : base(csvLine) { }

        public SummaryOne_DATA_FIELD_DESCRIPTORS(string[] values) : base(values) { }

        public SummaryOne_DATA_FIELD_DESCRIPTORS(OleDbDataReader reader)
        {
