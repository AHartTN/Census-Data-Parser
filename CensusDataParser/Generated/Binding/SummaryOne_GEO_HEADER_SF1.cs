...
// File: SummaryOne_GEO_HEADER_SF1.cs
// 
...
namespace CensusDataParser.Generated.Binding
{
    ...
    public class SummaryOne_GEO_HEADER_SF1 : BaseModel
    {
        #region Properties
        [MaxLength(6)]
        [ReadOnly(false)]
        ...
        #region Constructors
        public SummaryOne_GEO_HEADER_SF1(string csvLine) : base(csvLine) { }

        public SummaryOne_GEO_HEADER_SF1(string[] values) : base(values) { }

        public SummaryOne_GEO_HEADER_SF1(OleDbDataReader reader, CensusFileType fileType)
        {
