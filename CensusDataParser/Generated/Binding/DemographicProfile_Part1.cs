...
namespace CensusDataParser.Generated.Binding
{
    ...
    public class DemographicProfile_Part1 : BaseModel
    {
        ...
        public DemographicProfile_Part1(OleDbDataReader reader, CensusFileType fileType)
        {
            ...
            {
                DPSF0020001 = (double?)reader[62];
            }
            if (reader[63] != DBNull.Value)
            {
                DPSF0020002 = (double?)reader[63];
            }
            if (reader[64] != DBNull.Value)
            {
                DPSF0020003 = (double?)reader[64];
            }
            ...
            {
                DPSF0160001 = (double?)reader[171];
            }
            if (reader[172] != DBNull.Value)
            {
                DPSF0170001 = (double?)reader[172];
            }
            ...
            {
                DPSF0190001 = (double?)reader[182];
            }
            if (reader[183] != DBNull.Value)
            {
                DPSF0200001 = (double?)reader[183];
            }
            ...
            {
                DPSF0230001 = (double?)reader[189];
            }
            if (reader[190] != DBNull.Value)
            {
                DPSF0230002 = (double?)reader[190];
            }
        }
