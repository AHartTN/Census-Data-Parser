...
// Authored: 01/02/2016 11:23 AM
// 
// Solution: CensusDataParser
// Project: CensusDataParser
// File: SummaryOne_SF1_00009.cs
// 
...
namespace CensusDataParser.Generated.Binding
{
    ...
    public class SummaryOne_SF1_00009 : BaseModel
    {
        #region Properties
        [MaxLength(255)]
        [ReadOnly(false)]
        ...
        #region Constructors
        public SummaryOne_SF1_00009(string csvLine) : base(csvLine) { }

        public SummaryOne_SF1_00009(string[] values) : base(values) { }

        public SummaryOne_SF1_00009(OleDbDataReader reader, CensusFileType fileType)
        {
            ...
            {
                P017B001 = (double?)reader[5];
            }
            if (reader[6] != DBNull.Value)
            {
                P017B002 = (double?)reader[6];
            }
            if (reader[7] != DBNull.Value)
            {
                P017B003 = (double?)reader[7];
            }
            if (reader[8] != DBNull.Value)
            {
                P017C001 = (double?)reader[8];
            }
            if (reader[9] != DBNull.Value)
            {
                P017C002 = (double?)reader[9];
            }
            if (reader[10] != DBNull.Value)
            {
                P017C003 = (double?)reader[10];
            }
            if (reader[11] != DBNull.Value)
            {
                P017D001 = (double?)reader[11];
            }
            if (reader[12] != DBNull.Value)
            {
                P017D002 = (double?)reader[12];
            }
            if (reader[13] != DBNull.Value)
            {
                P017D003 = (double?)reader[13];
            }
            if (reader[14] != DBNull.Value)
            {
                P017E001 = (double?)reader[14];
            }
            if (reader[15] != DBNull.Value)
            {
                P017E002 = (double?)reader[15];
            }
            if (reader[16] != DBNull.Value)
            {
                P017E003 = (double?)reader[16];
            }
            if (reader[17] != DBNull.Value)
            {
                P017F001 = (double?)reader[17];
            }
            if (reader[18] != DBNull.Value)
            {
                P017F002 = (double?)reader[18];
            }
            if (reader[19] != DBNull.Value)
            {
                P017F003 = (double?)reader[19];
            }
            if (reader[20] != DBNull.Value)
            {
                P017G001 = (double?)reader[20];
            }
            if (reader[21] != DBNull.Value)
            {
                P017G002 = (double?)reader[21];
            }
            if (reader[22] != DBNull.Value)
            {
                P017G003 = (double?)reader[22];
            }
            if (reader[23] != DBNull.Value)
            {
                P017H001 = (double?)reader[23];
            }
            if (reader[24] != DBNull.Value)
            {
                P017H002 = (double?)reader[24];
            }
            if (reader[25] != DBNull.Value)
            {
                P017H003 = (double?)reader[25];
            }
            if (reader[26] != DBNull.Value)
            {
                P017I001 = (double?)reader[26];
            }
            if (reader[27] != DBNull.Value)
            {
                P017I002 = (double?)reader[27];
            }
            if (reader[28] != DBNull.Value)
            {
                P017I003 = (double?)reader[28];
            }
