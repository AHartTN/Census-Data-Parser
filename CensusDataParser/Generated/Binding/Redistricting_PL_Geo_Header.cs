...
// File: Redistricting_PL_Geo_Header.cs
// 
...
namespace CensusDataParser.Generated.Binding
{
    ...
    public class Redistricting_PL_Geo_Header : BaseModel
    {
        #region Properties
        ...
        #region Constructors
        public Redistricting_PL_Geo_Header() { }

        public Redistricting_PL_Geo_Header(string csvLine) : base(csvLine) { }

        public Redistricting_PL_Geo_Header(string[] values) : base(values) { }

        public Redistricting_PL_Geo_Header(OleDbDataReader reader)
        {
