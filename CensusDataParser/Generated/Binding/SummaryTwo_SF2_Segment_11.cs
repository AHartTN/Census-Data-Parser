...
// Authored: 01/02/2016 11:59 AM
// 
// Solution: CensusDataParser
// Project: CensusDataParser
// File: SummaryTwo_SF2_Segment_11.cs
// 
...
namespace CensusDataParser.Generated.Binding
{
    ...
    public class SummaryTwo_SF2_Segment_11 : BaseModel
    {
        ...
        public SummaryTwo_SF2_Segment_11(OleDbDataReader reader, CensusFileType fileType)
        {
            ...
            {
                HCT0050001 = (double?)reader[14];
            }
            if (reader[15] != DBNull.Value)
            {
                HCT0050002 = (double?)reader[15];
            }
            if (reader[16] != DBNull.Value)
            {
                HCT0050003 = (double?)reader[16];
            }
