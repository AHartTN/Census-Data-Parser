...
namespace CensusDataParser.Generated.Binding
{
	...
	public class SF1CongressionalDistricts113_GEO_HEADER_SF1 : BaseModel
	{
		...
		public decimal? AREAWATR { get; set; }
		...
		public SF1CongressionalDistricts113_GEO_HEADER_SF1(OleDbDataReader reader)
		{
			...
			{
				AREALAND = (decimal?)reader[63];
			}
			if (reader[64] != DBNull.Value)
			{
				AREAWATR = (decimal?)reader[64];
			}
