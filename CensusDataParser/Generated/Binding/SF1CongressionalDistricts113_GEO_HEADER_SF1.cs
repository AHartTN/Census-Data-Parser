...
// File: SF1CongressionalDistricts113_GEO_HEADER_SF1.cs
// 
...
namespace CensusDataParser.Generated.Binding
{
    ...
    public class SF1CongressionalDistricts113_GEO_HEADER_SF1 : BaseModel
    {
        #region Properties
        [MaxLength(6)]
        [ReadOnly(false)]
        ...
        public double? AREAWATR { get; set; }
        ...
        #region Constructors
        public SF1CongressionalDistricts113_GEO_HEADER_SF1(string csvLine) : base(csvLine) { }

        public SF1CongressionalDistricts113_GEO_HEADER_SF1(string[] values) : base(values) { }

        public SF1CongressionalDistricts113_GEO_HEADER_SF1(OleDbDataReader reader, CensusFileType fileType)
        {
            ...
            {
                AREALAND = (double?)reader[63];
            }
            if (reader[64] != DBNull.Value)
            {
                AREAWATR = (double?)reader[64];
            }
