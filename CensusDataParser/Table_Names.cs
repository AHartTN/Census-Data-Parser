...
namespace CensusDataParser
{
    ...
    {
        [Display(Name = "Column Count", ShortName = "Columns", Order = 3)]
        ...
        [Display(Name = "Table Code", ShortName = "Code", Order = 1)]
        public string TABLE_CODE { get; set; }

        [Display(Name = "Table Name", ShortName = "Name", Order = 2)]
